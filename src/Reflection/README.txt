...
I think using the reflection mechanism + dynamic casting I should be able to pass unknown functions to be executed within the SAMYCore.
Also the reflection mechanism should allow me to reduce a looot of code regarding node adding, commands-instantiation related stuff, etc.


REWRITE SPECIALLY HELPERS USING REFLECTION!! A LOOOOT OF CODE TO REMOVE

usage_examples contains some examples of possible usage of the Reflection mechanism
