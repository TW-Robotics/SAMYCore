...
RUN apt update
RUN apt install -y libboost-python1.71.0 build-essential cmake nano libyaml-cpp-dev libboost-all-dev git
...
#ENTRYPOINT ["tail"]
#CMD ["-f","/dev/null"]
CMD ["/usr/src/samy/build/SAMYCore"]
